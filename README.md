...
- `src/apps/labs/lab_7`: temporal backfill observability with a deterministic bronze source, per-date StageMetrics, and an optional Streamlit dashboard for daily volume spikes.
